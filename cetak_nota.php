...
function Header()
{
    ...
    $this->Cell(30,10,'JUALAN-KU');

    $this->Ln(10);
    $this->SetFont('Arial','i',10);
    $this->cell(30,10,'JL.CITARUM X');

    $this->cell(80);
    $this->SetFont('Arial','',10);
    $this->cell(30,10,'CIKARANG, '.base64_decode($_GET['uuid']).'');
    $this->Line(10,40,200,40);

    $this->Ln(5);
    $this->SetFont('Arial','i',10);
    $this->cell(30,10,'Telp/Fax : 089625484954');
    $this->Line(10,40,200,40);
...
$pdf->Output('','JUALAN-KU/'.$filename.'.pdf');
?>
